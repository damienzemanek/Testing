...
//
//         public Fluid<ValueType> nestedOR_vt = new Fluid<ValueType>(new ValueType(5));
//         [AutoBox] public Fluid<ValueType> nestedOR_ref = new Fluid<ValueType>(new ValueType(5));
//
//         public Fluid<int> OR_valuetype = new(5);
//         [AutoBox] public Fluid<int> OR_reference = new(5);
//
