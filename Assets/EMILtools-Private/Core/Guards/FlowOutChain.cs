...
public readonly struct Link
{
    ...
    [HorizontalGroup("Top", 250)] [ShowInInspector, ReadOnly]
    public readonly string If;

    [HorizontalGroup("Top")]
    [ShowInInspector, ReadOnly, HideLabel]
    public bool V => thisIs?.Invoke() ?? false;

    [HorizontalGroup("Bottom", 250)] [ShowInInspector, ReadOnly]
...
public abstract class FlowOutChain
{
    ...
    public static readonly Link NONE_LINK = new Link(NONE, null, NONE, null);
